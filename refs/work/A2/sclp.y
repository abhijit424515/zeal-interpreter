...
program
    : global_decl_statement_list_with_func func_def             { if (!stop_after_parse) print_program_ast(); }
    | global_var_decl_stmt_list func_def                        { if (!stop_after_parse) print_program_ast(); }
    | func_def                                                  { if (!stop_after_parse) print_program_ast(); }
;
